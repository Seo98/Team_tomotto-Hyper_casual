...
| **프로젝트 리드 & 잡부** | **게임플레이 & 밸런싱** | **UI/UX & 사운드** |
| 시스템 설계, 매니저 구현 | 몬스터 AI, 공격 시스템 | 인터페이스, 효과음 |
...
| **얼음탄** | 적 추적, 슬로우 효과 | 데미지↑, 발사속도↑ |
| **하푼** | 관통형, 고데미지 | 데미지↑, 쿨타임↓ |
| **화염** | 지속 데미지, 범위 공격 | 지속시간↑, 데미지↑ |
| **펫** | 자동 공격, 적 추적 | 데미지↑, 공격속도↑ |
...
### 💡 기술적 성과
- **깔끔한 상속 구조**로 확장성 확보
- **매니저 패턴**으로 시스템간 결합도 최소화
- **모바일 터치 최적화**로 직관적인 조작감 구현
- **오브젝트 풀링**으로 성능 최적화
